...
//#region Тут происходит создание элементов, добавление им элментов и текста
let renderCards = function(data, id){
    let listItem = createElement('div', ['col-sm-6', 'col-md-3', 'col-3', 'item'], id);
